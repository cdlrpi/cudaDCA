...
with open('graphomp.mtx') as file:
    time4 = [[float(digit) for digit in line.split()] for line in file]
with open('numbodsomp.mtx') as file:
...
plt.plot(numbods[0,:],Time4[0,:])
plt.xlabel("number of bodies")
plt.title("graph")
plt.legend(['openMP 8 cores', '1 gpu assembly','2 gpu assembly','3 gpu assembly','4 gpu assembly','5 gpu assembly','6 gpu assembly','7 gpu assembly','8 gpu assembly','9 gpu assembly','10 gpu assembly','11 gpu assembly'],'best')
plt.show()
