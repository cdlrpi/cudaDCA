...
plt.plot(numbods[0,:],Time4[0,:],numbods[0,:],Time4[1,:],numbods[0,:],Time4[2,:],numbods[0,:],Time4[3,:],numbods[0,:],Time4[4,:])
plt.ylabel("Time [s]")
plt.xlabel("number of bodies")
plt.title("graph")
plt.legend(['all cpu', '3 gpu assembly','6 gpu assembly','9 gpu assembly','12 gpu assembly','5 gpu assembly','6 gpu assembly','7 gpu assembly','8 gpu assembly','9 gpu assembly','10 gpu assembly','11 gpu assembly'],'best')
plt.show()
