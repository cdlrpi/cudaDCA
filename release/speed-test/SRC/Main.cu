...
#include <iostream>
#include <math.h>
#include "DCA_Functions/classes.h"
...
//average of points at first, but don't feel like waiting for larger numbers of bodies.
	...
	RK_45(inits,tstep,n,m,l,II,Y,cut_off,Zs,times, reps);//Call the integrator, in this version the integrator is not functioning for timing purposes
