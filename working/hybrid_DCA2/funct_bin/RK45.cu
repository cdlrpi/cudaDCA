...
void DCAhelp(double state[], double m[], double l[], double I[],int n, double Y[],int cut_off);
...
void RK_45(double state[], double step, int n,double m[], double l[], double II[],double Y[],int cut_off)
{
	...
	DCAhelp(tState,m,l,II,n,Y1,cut_off);
	arycpy3(qddot1,Y1,n);
